...
const BGM: Record<string, AudioSource> = {
  ...
  bgm_kamabokosachiko_10: require("@/assets/audio/bgm/ループあり/蒲鉾さちこ/優しい海辺.mp3"),
  bgm_kamabokosachiko_11: require("@/assets/audio/bgm/ループあり/蒲鉾さちこ/優しい灯火(Tenderly_glow).mp3"),
  bgm_kamabokosachiko_12: require("@/assets/audio/bgm/ループあり/蒲鉾さちこ/波打つ鼓動.mp3"),
  bgm_kamabokosachiko_13: require("@/assets/audio/bgm/ループあり/蒲鉾さちこ/精霊が棲まう森.mp3"),
  ...
  bgm_bach_01: require("@/assets/audio/bgm/ループなし/J.S.バッハ/メヌエット長調.mp3"),
  bgm_bach_02: require("@/assets/audio/bgm/ループなし/J.S.バッハ/主よ、人の望みの喜びよ.mp3"),
  ...
  bgm_elgar_01: require("@/assets/audio/bgm/ループなし/エルガー/愛のあいさつ.mp3"),
  ...
  bgm_satie_01: require("@/assets/audio/bgm/ループなし/サティ/ジムノペディ(ピアノ).mp3"),
  bgm_schumann_01: require("@/assets/audio/bgm/ループなし/シューマン/《子供の情景》第7曲『トロイメライ』.mp3"),
  bgm_chopin_01: require("@/assets/audio/bgm/ループなし/ショパン/前奏曲_第15番_変ニ長調_雨だれ.mp3"),
  bgm_chopin_02: require("@/assets/audio/bgm/ループなし/ショパン/前奏曲_第7番_イ長調.mp3"),
  bgm_debussy_01: require("@/assets/audio/bgm/ループなし/ドビュッシー/《ベルガマスク組曲》より 3. 月の光.mp3"),
  ...
  bgm_pachelbel_01: require("@/assets/audio/bgm/ループなし/パッヘルベル/カノン ニ長調.mp3"),
  bgm_beethoven_01: require("@/assets/audio/bgm/ループなし/ベートーヴェン/悲愴_第二楽章.mp3"),
  bgm_beethoven_02: require("@/assets/audio/bgm/ループなし/ベートーヴェン/月光第一楽章.mp3"),
  bgm_massenet_01: require("@/assets/audio/bgm/ループなし/マスネ/瞑想曲.mp3"),
  bgm_liszt_01: require("@/assets/audio/bgm/ループなし/リスト/愛の夢_第3番_変イ長調_「おお、愛しうる限り愛せ」(ピアノ).mp3"),
  ...
  bgm_kouyatakashi_04: require("@/assets/audio/bgm/ループなし/稿屋　隆/ガリレオの脳ミソ.mp3"),
  ...
  bgm_kamabokosachiko_14: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/Luminous_time.mp3"),
  ...
  bgm_kamabokosachiko_15: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/Unbelievable_dream.mp3"),
  bgm_kamabokosachiko_07: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/White_snow_chill_days.mp3"),
  bgm_kamabokosachiko_16: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/優しい憂雨に.mp3"),
  bgm_kamabokosachiko_17: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/優しい日だまりと、静寂.mp3"),
  bgm_kamabokosachiko_18: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/優しい窓辺.mp3"),
  bgm_kamabokosachiko_19: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/冬の訪れ.mp3"),
  bgm_kamabokosachiko_20: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/初夏の風を感じて….mp3"),
  bgm_kamabokosachiko_21: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/夜と静寂(The_night_and_quiet).mp3"),
  bgm_kamabokosachiko_22: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/夜闇に、風に紛れて.mp3"),
  bgm_kamabokosachiko_08: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/年を刻んで.mp3"),
  bgm_kamabokosachiko_23: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/木漏れ日と温もり.mp3"),
  bgm_kamabokosachiko_24: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/柔らかな温もり.mp3"),
  bgm_kamabokosachiko_25: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/秋、深まりて.mp3"),
  bgm_kamabokosachiko_26: require("@/assets/audio/bgm/ループなし/蒲鉾さちこ/秋を眺めて.mp3"),
