...
//
// 現状は時間帯ごとの差分素材が無いため、登録済みは night のみ。差分ができたら各街に
...
const TOWN_ART: Record<string, TownArt> = {
  // nightTown（海辺の港町テーマ）。night の Lv.1〜Lv.5 がそろっている。
  nightTown: {
    night: {
      1: require("@/assets/images/home/nightTown/nightTown_night_lv1.png"),
      2: require("@/assets/images/home/nightTown/nightTown_night_lv2.png"),
      3: require("@/assets/images/home/nightTown/nightTown_night_lv3.png"),
      4: require("@/assets/images/home/nightTown/nightTown_night_lv4.png"),
      5: require("@/assets/images/home/nightTown/nightTown_night_lv5.png"),
    },
  },
